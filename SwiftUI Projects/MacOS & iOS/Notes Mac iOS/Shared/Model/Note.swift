...
var notes: [Note] = [
    Note(title: "India" ,note: "India’s third lunar mission, Chandrayaan – 3 made history on August 23, 2023, by successfully achieving a soft landing on the south pole of the moon. ", date: getSampleDate(offset: 1), cardColor: "Color-Red", password: ""),
